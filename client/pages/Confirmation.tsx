...
const Confirmation = () => {
  return (
    ...
    >
      ...
      <section className="px-4 lg:px-6 xl:px-36 py-16 lg:py-24">
        <div className="flex justify-center items-center min-h-[60vh]">
          <div className="text-center w-full max-w-2xl mx-auto bg-white/80 backdrop-blur-sm p-8 lg:p-12 rounded-3xl shadow-xl border border-white/20">
            <div className="space-y-6">
              {/* Success Icon */}
              <div className="mx-auto w-16 h-16 lg:w-20 lg:h-20 bg-vybecoderz-purple rounded-full flex items-center justify-center mb-6">
                <svg
              ...
              {/* Title */}
              <h1 className="text-3xl lg:text-5xl bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent font-inter font-semibold leading-tight">
                You're on the list!
              </h1>

              {/* Description */}
              <div className="space-y-4">
                <p className="text-black text-base lg:text-lg font-inter font-light leading-relaxed">
                  Thank you for sharing your email with Vybe Coderz. We'll be in
                  touch soon with exclusive updates and community news.
                </p>
                <p className="text-black/70 text-sm lg:text-base font-inter">
                  Keep an eye on your inbox for what's coming next!
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
                <Link
                  to="/"
                  className="bg-vybecoderz-blue border border-black/20 rounded-full px-8 py-3 text-vybecoderz-navy font-inter text-base font-medium backdrop-blur-sm hover:bg-vybecoderz-purple hover:text-white transition-colors"
                >
                  Back to Home
                </Link>
                <Link
                  to="/features"
                  className="bg-vybecoderz-peach border border-black/20 rounded-full px-8 py-3 text-vybecoderz-navy font-inter text-base font-medium backdrop-blur-sm hover:bg-vybecoderz-purple hover:text-white transition-colors"
                >
                  Explore Features
                </Link>
              </div>
              ...
              <div className="pt-6 border-t border-black/10">
                <p className="text-black/60 text-xs lg:text-sm font-inter">
                  Want to stay connected? Follow us on social media for the
                  latest updates.
                </p>
              </div>
            </div>
